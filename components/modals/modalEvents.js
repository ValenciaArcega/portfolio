...
const modalWindow = document.querySelectorAll('.modal-skill-One, .modal-skill-Two, .modal-skill-Three, .modal-skill-Four, .modal-skill-Five, .modal-skill-Six, .modal-skill-Seven, .modal-skill-Eight');
